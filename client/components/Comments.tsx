                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div
                                    /* No `prose` classes: @tailwindcss/typography is not installed,
                                       so they were inert. Styling comes from lib/markdown.ts, which
                                       emits theme-token classes that adapt to dark mode. */
                                    className="text-sm text-foreground/90 mt-1 leading-relaxed max-w-none break-words"
